...
string GerarTokenJwt(Administrador administrador){
    if(string.IsNullOrEmpty(key)) return string.Empty; // Verifica apenas se a chave está vazia
...
ErrosDeValidacao validaDTO(VeiculoDTO veiculoDTO){
    ...
    if(veiculoDTO.Ano < 1950){
        validacao.Mensagens.Add("Veículo muito antigo, apenas aceitamos anos superiores a 1950");
    }
